    ...
    try:
        with open('stats.json', 'w') as f:
            json.dump({
                ...
                'photos_received': stats['photos_received'],
                'audios_received': stats['audios_received'],
...
<body>
    <div class="container">
        ...
        <div class="status">
            ...
            <div class="stat">📨 Total: ''' + str(stats['total_requests']) + '''</div>
            <div class="stat">📸 Fotos: ''' + str(stats['photos_received']) + '''</div>
            <div class="stat">🎤 Áudios: ''' + str(stats['audios_received']) + '''</div>
            <div class="stat">📱 Dispositivos: ''' + str(len(stats['devices'])) + '''</div>
            <div class="stat">🕒 Última conexão: ''' + (stats['last_connection'].strftime('%Y-%m-%d %H:%M:%S') if stats['last_connection'] else "Nenhuma") + '''</div>
        </div>
        ...
        <div style="margin-top: 30px; padding: 20px; background: rgba(0,0,0,0.2); border-radius: 10px;">
            ...
            <ul style="margin-left: 20px;">
                ...
                <li><code>GET /audios</code> - Apenas áudios</li>
            </ul>
        </div>
    </div>
